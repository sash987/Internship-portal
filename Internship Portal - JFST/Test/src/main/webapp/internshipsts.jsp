...
TATA CONSULTANCY SERVICES has accredited our college in the year 2011, from which they are visiting our college every year for conducting Placement Training programmes and Campus Interviews.
</p></div>


<div class="divi">
<h1>OBJECTIVE</h1>
<p><ul>Developing the students to meet the Industries recruitment process</ul>
<ul>To motivate students to develop Technical knowledge and soft skills in terms of career planning, goal setting</ul>
<ul>To motivate students aspire for higher studies and guiding them to take competitive exams such as CAT, GATE, TOEFL, GRE, IES,UPSC,TNPSC etc</ul>
<ul>Aiming to Place the maximum number of students through campus & off-campus interviews conducted by the top companies</ul>
<ul>Providing resources and activities to facilitate the career planning process</ul>
</p>
<div class="divu">
<img src="http://vcenggw.ac.in/images/gallery/placement/Salient%20features.jpg" alt="" width="500" height="500"></div></div>
<div class="divi">
<h1>Career Development Programs organized by Training and Placement Cell</h1>
<div class="divu">
<img src="http://vcenggw.ac.in/images/gallery/placement/cdp.jpg" alt="" width="500" height="500"></div>
</div>
</body>
</html>